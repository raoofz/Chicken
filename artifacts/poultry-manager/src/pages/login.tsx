    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4" dir="rtl">
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground">مدير المزرعة</h1>
          <p className="text-muted-foreground mt-1">نظام إدارة الدواجن الذكي</p>
        </div>

        <Card className="shadow-2xl border-border/50 backdrop-blur-sm bg-card/95">
          <CardHeader className="pb-4">
            <CardTitle className="text-xl text-center">تسجيل الدخول</CardTitle>
            <CardDescription className="text-center">أدخل بيانات حسابك للوصول إلى النظام</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          نظام متكامل لإدارة مزارع الدواجن بتقنية الذكاء الاصطناعي
        </p>
      </div>
    </div>
  );
